...
execute if score #temp_1 tcc.dummy matches 0 run function tcc:postgen/bootleg_jigsaw/ocean_ruin_addition/cold/setblock_treasure
execute if score #temp_1 tcc.dummy matches 1 run function tcc:postgen/bootleg_jigsaw/ocean_ruin_addition/cold/setblock_trident
