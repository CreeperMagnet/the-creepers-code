############################################################
# Finishes off the generation of the new monument, clearing out old entities and adding in new content
############################################################

execute positioned ~-40 0 ~-40 run kill @e[type=#tcc:monument_cleanup,tag=!smithed.entity,dx=80,dy=256,dz=80]
