#> tcc:postgen/random RUN AS AN ENTITY
...
execute store result score #in_0 tcc.dummy run data get entity @s Pos[0]
execute store result score #in_1 tcc.dummy run data get entity @s Pos[2]
