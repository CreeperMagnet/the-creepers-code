...
execute if score @s tcc.dummy2 matches 1 run function tcc:block/decorated_pot/interact/reset_barrier_to_pot with entity @s item.components."minecraft:custom_data".pot_data
