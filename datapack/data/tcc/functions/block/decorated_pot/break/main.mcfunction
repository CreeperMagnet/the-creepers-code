...
execute as @e[tag=!smithed.entity,limit=1,type=minecraft:item,distance=..2,nbt={Item:{tag:{BlockEntityTag:{sherds:["minecraft:air","minecraft:air","minecraft:air","minecraft:air"]}},id:"minecraft:decorated_pot",Count:1b}}] run function tcc:block/decorated_pot/break/as_item
