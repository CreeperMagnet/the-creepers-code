...
execute if entity @s[advancements={tcc:technical/block/click_teapot={add_water=true}},gamemode=!creative] run item entity @s weapon.mainhand replace minecraft:glass_bottle 1
...
execute unless entity @s[advancements={tcc:technical/block/click_teapot={add_warped_wart=false,add_snail_mucus=false}}] if entity @s[gamemode=!creative] run item entity @s weapon.mainhand modify tcc:reduce_count
