...
execute if entity @s[advancements={tcc:technical/block/click_teapot={add_warped_wart=true}},gamemode=!creative] run item entity @s weapon.mainhand modify tcc:reduce_count
