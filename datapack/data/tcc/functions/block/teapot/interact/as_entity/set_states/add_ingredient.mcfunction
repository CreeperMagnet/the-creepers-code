...
execute if data storage tcc:storage root.temp.item{id:"minecraft:dandelion"} run data modify entity @s HandItems[0].tag.tcc.tea set value {id:"steadiness",color:16772175,extended:0b}
execute if data storage tcc:storage root.temp.item{id:"minecraft:wither_rose"} run data modify entity @s HandItems[0].tag.tcc.tea set value {id:"purity",color:4338990,extended:0b}
execute if data storage tcc:storage root.temp.item{id:"minecraft:sea_pickle"} run data modify entity @s HandItems[0].tag.tcc.tea set value {id:"clearsight",color:7107114,extended:0b}
execute if data storage tcc:storage root.temp.item{id:"minecraft:ink_sac"} run data modify entity @s HandItems[0].tag.tcc.tea set value {id:"obscurity",color:6513542,extended:0b}
