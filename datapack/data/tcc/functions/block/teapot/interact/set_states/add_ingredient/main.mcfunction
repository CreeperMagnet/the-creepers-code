...
execute if data storage tcc:storage root.temp.item{id:"minecraft:glow_lichen"} run function tcc:block/teapot/interact/set_states/add_ingredient/clearsight
