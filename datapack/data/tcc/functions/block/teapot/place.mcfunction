...
item entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,tag:{tcc:{id:"teapot"}}}]},nbt=!{SelectedItem:{tag:{tcc:{id:"teapot"}}}}] weapon.offhand replace air
item entity @s[gamemode=!creative,nbt={SelectedItem:{tag:{tcc:{id:"teapot"}}}}] weapon.mainhand replace air
