...
execute as @e[type=minecraft:item_display,distance=..7,tag=tcc.pottery_table] at @s if block ~ ~ ~ minecraft:barrel[open=false] run function tcc:block/pottery_table/open
