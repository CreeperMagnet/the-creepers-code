...
execute if entity @s[tag=tcc.tag] unless block ~ ~ ~ barrel{Items:[{Slot:13b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 13b
execute if entity @s[tag=tcc.tag] if block ~ ~ ~ barrel{Items:[{Slot:13b}]} unless block ~ ~ ~ barrel{Items:[{Slot:21b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 21b
execute if entity @s[tag=tcc.tag] if block ~ ~ ~ barrel{Items:[{Slot:13b}]} if block ~ ~ ~ barrel{Items:[{Slot:21b}]} unless block ~ ~ ~ barrel{Items:[{Slot:11b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 11b
execute if entity @s[tag=tcc.tag] if block ~ ~ ~ barrel{Items:[{Slot:13b}]} if block ~ ~ ~ barrel{Items:[{Slot:21b}]} if block ~ ~ ~ barrel{Items:[{Slot:11b}]} unless block ~ ~ ~ barrel{Items:[{Slot:3b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 3b
execute if entity @s[tag=tcc.tag] if block ~ ~ ~ barrel{Items:[{Slot:13b}]} if block ~ ~ ~ barrel{Items:[{Slot:21b}]} if block ~ ~ ~ barrel{Items:[{Slot:11b}]} if block ~ ~ ~ barrel{Items:[{Slot:3b}]} unless block ~ ~ ~ barrel{Items:[{Slot:12b}]} run data modify block ~ ~ ~ Items[{Slot:0b}].Slot set value 12b
tag @s remove tcc.tag
