...
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:13b}] run function tcc:block/pottery_table/crafting/create_output/decorate_pot/nether_brick/lore/0
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:21b}] run function tcc:block/pottery_table/crafting/create_output/decorate_pot/nether_brick/lore/1
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:3b}] run function tcc:block/pottery_table/crafting/create_output/decorate_pot/nether_brick/lore/2
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:11b}] run function tcc:block/pottery_table/crafting/create_output/decorate_pot/nether_brick/lore/3
