...
data modify storage tcc:storage root.temp.compare[1] set from block ~ ~ ~ Items[{Slot:3b}]
scoreboard players set @s tcc.dummy 1
function tcc:block/pottery_table/crafting/check_slot_validity/check_vs_middle_sherd
execute if score @s tcc.dummy matches 0 run function tcc:block/pottery_table/crafting/check_slot_validity/3/export
execute unless predicate tcc:block/pottery_table/item_types/sherds run function tcc:block/pottery_table/crafting/check_slot_validity/3/export
