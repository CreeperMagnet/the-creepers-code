...
execute if block ~ ~ ~ hopper{Items:[{Slot:0b,tag:{Enchantments:[{}]}},{Slot:2b}]} run function tcc:block/jewelry_table/updated_slot/2
execute if block ~ ~ ~ hopper{Items:[{Slot:0b,tag:{tcc:{id:"ring",potion:{}}}},{Slot:3b}]} run function tcc:block/jewelry_table/export_slot/3
