...
execute if block ~ ~ ~ minecraft:hopper{Items:[{tag:{tcc:{id:"ring",gemstone:{}}},Slot:0b},{Slot:1b}]} run function tcc:block/jewelry_table/export_slot/1_check_gemstone
