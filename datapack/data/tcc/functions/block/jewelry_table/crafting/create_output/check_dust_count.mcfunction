...
execute if score @s tcc.dummy matches 2.. if data storage tcc:storage root.temp.barrel_data[1][{Slot:2b,id:"minecraft:iron_ingot"}] run function tcc:block/jewelry_table/crafting/create_output/metals/iron
execute if score @s tcc.dummy matches 3.. if data storage tcc:storage root.temp.barrel_data[1][{Slot:2b,id:"minecraft:netherite_ingot"}] run function tcc:block/jewelry_table/crafting/create_output/metals/netherite
