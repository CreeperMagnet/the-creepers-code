...
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:2b,id:"minecraft:iron_ingot"}] run item modify block ~ ~ ~ container.22 tcc:reduce_count/3
execute if data storage tcc:storage root.temp.barrel_data[1][{Slot:2b,id:"minecraft:netherite_ingot"}] run item modify block ~ ~ ~ container.22 tcc:reduce_count/5
