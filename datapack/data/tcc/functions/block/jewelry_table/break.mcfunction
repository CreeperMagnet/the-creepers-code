...
execute if data entity @s ArmorItems[3].tag.tcc.stored_slots[{Slot:4b,Count:1b}] as @e[type=item,sort=nearest,distance=..2,tag=!global.ignore] run function tcc:block/jewelry_table/break_delete_output
