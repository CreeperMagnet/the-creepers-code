...
summon armor_stand ~ ~ ~ {CustomName:'{"translate":"block.tcc.jewelry_table"}',ArmorItems:[{},{},{},{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:330000,tcc:{stored_barrel_data:[[],[]]}}}],Tags:["tcc.block","tcc.tick","tcc.second_clock","tcc.ten_second_clock","tcc.jewelry_table","smithed.entity","smithed.block","tcc.prevents_hoppers"],NoGravity:1b,Invisible:1b,Marker:1b}
