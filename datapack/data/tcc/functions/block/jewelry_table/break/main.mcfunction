...
execute as @e[tag=!smithed.entity,limit=1,type=item,distance=..3,nbt={PickupDelay:10s,Item:{id:"minecraft:barrel",tag:{display:{Name:'{"color":"white","font":"tcc:jewelry_table","translate":"block.tcc.jewelry_table.gui","with":[{"color":"#3F3F3F","font":"minecraft:default","translate":"block.tcc.jewelry_table"}]}'}}}}] at @s run function tcc:block/jewelry_table/break/kill_item
