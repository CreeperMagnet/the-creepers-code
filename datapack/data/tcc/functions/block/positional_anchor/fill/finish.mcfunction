...
execute if entity @s[tag=tcc.tag] run setblock ~ ~ ~ dropper[facing=down,triggered=true]{Items:[{Slot:4b,id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:330000,tcc:{id:"positional_anchor_item"}}}],CustomName:'{"font":"tcc:technical","translate":"block.tcc.positional_anchor.name"}',Lock:"positional_anchor_filled\\uF001"}
execute if entity @s[tag=!tcc.tag] run setblock ~ ~ ~ dropper[facing=down,triggered=false]{Items:[{Slot:4b,id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:330000,tcc:{id:"positional_anchor_item"}}}],CustomName:'{"font":"tcc:technical","translate":"block.tcc.positional_anchor.name"}',Lock:"positional_anchor_filled\\uF001"}
