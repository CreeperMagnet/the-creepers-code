...
execute store success score tcc.temp_0 tcc.dummy run kill @e[tag=!global.ignore,tag=!global.ignore.kill,limit=1,type=item,distance=..2,nbt={Age:1s,Item:{id:"minecraft:spruce_sapling",Count:1b}}]
