...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #tcc:horizontally_connectable[west=true] run scoreboard players set @s tcc.dummy2 1
...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #tcc:chests[facing=north,type=right] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #tcc:chests[facing=south,type=left] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ minecraft:ladder[facing=east] run scoreboard players set @s tcc.dummy2 1
...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:doors[facing=east] run scoreboard players set @s tcc.dummy2 1
...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:doors[facing=south,open=true,hinge=right] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:doors[facing=north,open=true,hinge=left] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:doors[facing=west,open=true] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:trapdoors unless block ~ ~ ~ #minecraft:trapdoors[facing=west,open=true] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #tcc:wall_heads[facing=east] run scoreboard players set @s tcc.dummy2 1
...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ minecraft:bell[facing=west,attachment=single_wall] run scoreboard players set @s tcc.dummy2 1
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #tcc:non_full_amethyst_blocks[facing=east] run scoreboard players set @s tcc.dummy2 1
...
execute unless score @s tcc.dummy2 matches 1 if block ~ ~ ~ #minecraft:walls unless block ~ ~ ~ #minecraft:walls[west=none] run scoreboard players set @s tcc.dummy2 1

execute unless score @s tcc.dummy2 matches 1 if block ^ ^ ^-.1 #minecraft:shulker_boxes[facing=east] run scoreboard players set @s tcc.dummy2 1
