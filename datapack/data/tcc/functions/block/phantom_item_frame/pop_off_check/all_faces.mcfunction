...
execute if entity @s[tag=tcc.phantom_item_frame.down] run function tcc:block/phantom_item_frame/pop_off_check/down
execute if entity @s[tag=tcc.phantom_item_frame.up] run function tcc:block/phantom_item_frame/pop_off_check/up
execute if entity @s[tag=tcc.phantom_item_frame.north] run function tcc:block/phantom_item_frame/pop_off_check/north
execute if entity @s[tag=tcc.phantom_item_frame.south] run function tcc:block/phantom_item_frame/pop_off_check/south
