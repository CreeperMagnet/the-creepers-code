...
execute if entity @s[scores={tcc.dummy=0}] run summon minecraft:item_display ~ ~.5 ~ {Tags:["tcc.tick","tcc.second_clock","tcc.phantom_item_frame","tcc.phantom_item_frame.update","smithed.entity","tcc.block"],Rotation:[0.0f,90.0f],transformation:{right_rotation:{angle:0.0f,axis:[0.0f,0.0f,0.0f]},scale:[1.0f,1.0f,1.0f],left_rotation:{angle:0.0f,axis:[0.0f,0.0f,0.0f]},translation:[0.0f,0.5f,0.5f]},item:{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330007}},view_range:4.0f}
execute if entity @s[scores={tcc.dummy=1}] run summon minecraft:item_display ~ ~.5 ~ {Tags:["tcc.tick","tcc.second_clock","tcc.phantom_item_frame","tcc.phantom_item_frame.update","smithed.entity","tcc.block"],Rotation:[0.0f,-90.0f],transformation:{right_rotation:{angle:0.0f,axis:[0.0f,0.0f,0.0f]},scale:[1.0f,1.0f,1.0f],left_rotation:{angle:0.0f,axis:[0.0f,0.0f,0.0f]},translation:[0.0f,0.5f,-0.5f]},item:{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330007}},view_range:4.0f}
execute if entity @s[scores={tcc.dummy=2}] run summon minecraft:item_display ~ ~.5 ~ {Tags:["tcc.tick","tcc.second_clock","tcc.phantom_item_frame","tcc.phantom_item_frame.update","smithed.entity","tcc.block"],Rotation:[180.0f,0.0f],item:{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330007}},view_range:4.0f}
execute if entity @s[scores={tcc.dummy=3}] run summon minecraft:item_display ~ ~.5 ~ {Tags:["tcc.tick","tcc.second_clock","tcc.phantom_item_frame","tcc.phantom_item_frame.update","smithed.entity","tcc.block"],item:{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330007}},view_range:4.0f}
execute if entity @s[scores={tcc.dummy=4}] run summon minecraft:item_display ~ ~.5 ~ {Tags:["tcc.tick","tcc.second_clock","tcc.phantom_item_frame","tcc.phantom_item_frame.update","smithed.entity","tcc.block"],Rotation:[90.0f,0.0f],item:{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330007}},view_range:4.0f}
