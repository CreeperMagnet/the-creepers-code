...
execute if entity @s[advancements={tcc:technical/player_interacted_with_entity/phantom_item_frame={add_item=true}}] run function tcc:block/phantom_item_frame/interact/add_item.player
