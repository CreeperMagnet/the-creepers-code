...
execute if block ~ ~-1 ~ #tcc:soul_conductor_ignore run teleport @s ~0.5 ~-1 ~0.5 ~ ~
execute if block ~ ~1 ~ #tcc:soul_conductor_ignore run teleport @s ~0.5 ~ ~0.5 ~ ~
execute unless block ~ ~1 ~ #tcc:soul_conductor_ignore unless block ~ ~-1 ~ #tcc:soul_conductor_ignore run teleport @s ~0.5 ~ ~0.5 ~ ~