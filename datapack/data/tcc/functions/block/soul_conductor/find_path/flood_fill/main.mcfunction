...
# Exits
execute unless score #soul_conductor_unfinished tcc.dummy matches 0 positioned ~ ~-1 ~ if block ~ ~ ~ dropper[facing=down]{Lock:"§soul_conductor\\uF001"} positioned ~ ~0.5 ~ unless entity @s[distance=..0.0001] positioned ~ ~-1.5 ~ if block ~ ~ ~ #tcc:soul_conductor_ignore rotated ~ 0 run function tcc:block/soul_conductor/find_path/finish
...
execute unless score #soul_conductor_unfinished tcc.dummy matches 0 positioned ~ ~1 ~ if block ~ ~ ~ dropper[facing=up]{Lock:"§soul_conductor\\uF001"} positioned ~ ~0.5 ~ unless entity @s[distance=..0.0001] positioned ~ ~0.5 ~ if block ~ ~ ~ #tcc:soul_conductor_ignore rotated ~ 0 run function tcc:block/soul_conductor/find_path/finish
