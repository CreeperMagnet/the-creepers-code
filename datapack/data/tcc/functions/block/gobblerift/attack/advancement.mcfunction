...
execute as @e[type=minecraft:interaction,tag=tcc.gobblerift,limit=1,sort=nearest,nbt={attack:{}}] at @s run function tcc:block/gobblerift/attack/as_interaction
