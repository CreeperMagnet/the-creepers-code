...
execute if entity @e[type=minecraft:wandering_trader,tag=tcc.gobblerift.in_love,distance=0.00001..1] run function tcc:block/gobblerift/feed_stew/set_love
