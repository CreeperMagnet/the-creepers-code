...
execute as @e[type=minecraft:interaction,tag=tcc.gobblerift,limit=1,sort=nearest,nbt={interaction:{}}] at @s run function tcc:block/gobblerift/interact/as_entity
