...
execute if entity @s[tag=tcc.gobblerift.juice_ready] unless data storage tcc:storage root.temp.full_inventory unless data storage tcc:storage root.temp.creative if data storage tcc:storage root.temp.item{id:"minecraft:glass_bottle"} run function tcc:block/gobblerift/interact/juice/survival
execute if entity @s[tag=tcc.gobblerift.juice_ready] unless data storage tcc:storage root.temp.full_inventory if data storage tcc:storage root.temp{creative:1b,item:{id:"minecraft:glass_bottle"}} run function tcc:block/gobblerift/interact/juice/creative