...
execute if data storage tcc:storage root.temp.name if data entity @s SelectedItem run loot give @s loot tcc:technical/riftjuice_bottle/named
execute unless data storage tcc:storage root.temp.name if data entity @s SelectedItem run loot give @s loot tcc:technical/riftjuice_bottle/unnamed
