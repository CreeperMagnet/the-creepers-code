...
execute if data storage tcc:storage root.temp.item.tag.tcc.potion{id:"tcc:fortitude"} run data modify storage tcc:storage root.temp.item.tag.display.Name set value '{"translate":"item.tcc.splash_potion.effect.fortitude","italic":false}'
execute if data storage tcc:storage root.temp.item.tag.tcc.potion{id:"tcc:long_fortitude"} run data modify storage tcc:storage root.temp.item.tag.display.Name set value '{"translate":"item.tcc.splash_potion.effect.fortitude","italic":false}'
execute if data storage tcc:storage root.temp.item.tag.tcc.potion{id:"tcc:strong_fortitude"} run data modify storage tcc:storage root.temp.item.tag.display.Name set value '{"translate":"item.tcc.splash_potion.effect.fortitude","italic":false}'
