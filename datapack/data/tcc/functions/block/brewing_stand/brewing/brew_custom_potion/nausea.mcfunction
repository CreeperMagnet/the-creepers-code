...
data modify storage tcc:storage root.temp.item.tag.CustomPotionEffects set value [{Id:9,Amplifier:0b,Duration:600}]
...
execute if data storage tcc:storage root.temp.item{id:"minecraft:lingering_potion"} run data modify storage tcc:storage root.temp.item.tag.CustomPotionEffects set value [{Id:9,Amplifier:0b,Duration:120}]
