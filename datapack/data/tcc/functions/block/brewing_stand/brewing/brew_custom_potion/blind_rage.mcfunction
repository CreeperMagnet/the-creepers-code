...
data modify storage tcc:storage root.temp.item.tag.CustomPotionEffects set value [{Id:15b,Amplifier:0b,Duration:300},{Id:5b,Amplifier:2b,Duration:300}]
...
execute if data storage tcc:storage root.temp.item{id:"minecraft:lingering_potion"} run data modify storage tcc:storage root.temp.item.tag.CustomPotionEffects set value [{Id:15b,Amplifier:0b,Duration:60},{Id:5b,Amplifier:2b,Duration:60}]
