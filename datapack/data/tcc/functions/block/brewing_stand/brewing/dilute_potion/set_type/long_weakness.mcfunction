...
data modify storage tcc:storage root.temp.item.tag.display.Lore prepend value '{"color":"red","italic":false,"translate":"potion.withDuration","with":[{"translate":"effect.minecraft.weakness"},{"translate":"potion.tcc.duration","with":[0,2,4]}]}'
