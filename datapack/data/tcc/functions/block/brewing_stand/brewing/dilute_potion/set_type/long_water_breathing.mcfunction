...
data modify storage tcc:storage root.temp.item.tag.display.Lore prepend value '{"color":"blue","italic":false,"translate":"potion.withDuration","with":[{"translate":"effect.minecraft.water_breathing"},{"translate":"potion.tcc.duration","with":[0,0,4,8]}]}'
