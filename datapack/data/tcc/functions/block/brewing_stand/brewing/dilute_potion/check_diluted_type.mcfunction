...
data modify storage tcc:storage root.temp.item set value {id:"minecraft:carrot_on_a_stick",Count:1b,tag:{RepairCost:100,tcc:{id:"diluted_potion",potion:{uses:[10,10]}},Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],CustomModelData:0,Unbreakable:1b,HideFlags:5}}
