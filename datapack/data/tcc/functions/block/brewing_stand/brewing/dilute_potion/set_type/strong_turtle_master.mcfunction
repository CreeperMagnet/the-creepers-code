...
data modify storage tcc:temp root.item.components."minecraft:lore" append value '{"color":"red","italic":false,"translate":"attribute.modifier.take.1","with":[90,{"translate":"attribute.name.generic.movement_speed"}]}'
