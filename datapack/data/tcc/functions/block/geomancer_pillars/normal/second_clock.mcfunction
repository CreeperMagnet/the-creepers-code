...
execute if entity @s[scores={tcc.dummy2=5}] run particle minecraft:item{item:{id:"minecraft:structure_block",components:{"minecraft:custom_model_data":330005}}} ~ ~1 ~ 0.5 1 0.5 0.1 100 normal
