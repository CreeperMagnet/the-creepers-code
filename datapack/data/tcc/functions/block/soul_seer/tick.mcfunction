...
execute if block ~ ~ ~ dropper[triggered=false] run tag @s remove tcc.soul_seer.powered
execute if block ~ ~ ~ dropper[triggered=true] unless entity @s[tag=tcc.soul_seer.powered] run function tcc:block/soul_seer/powered
