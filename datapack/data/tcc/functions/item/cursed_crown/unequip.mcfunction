...
data modify storage tcc:storage root.inventory_temp.Inventory[{id:"minecraft:carrot_on_a_stick",tag:{tcc:{id:"cursed_crown"}}}].id set value "minecraft:gold_helmet"
