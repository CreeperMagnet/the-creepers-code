...
execute if entity @s[predicate=!tcc:entity/wearing/cursed_crown] run effect clear @s minecraft:absorption
execute if entity @s[predicate=!tcc:entity/wearing/cursed_crown] run scoreboard players reset @s tcc.cursed_crown_cooldown
