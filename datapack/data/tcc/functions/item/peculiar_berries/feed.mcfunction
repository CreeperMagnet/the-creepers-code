...
item entity @s[gamemode=!creative,nbt={Inventory:[{tag:{tcc:{id:"peculiar_berries"}},Slot:-106b}]},nbt=!{SelectedItem:{tag:{tcc:{id:"peculiar_berries"}}}}] weapon.offhand replace air
item entity @s[gamemode=!creative,nbt={SelectedItem:{tag:{tcc:{id:"peculiar_berries"}}}}] weapon.mainhand replace air
