...
execute as @e[predicate=tcc:global.ignore,nbt={HurtTime:10s},distance=0.0000001..15,sort=arbitrary] run function tcc:item/tipped_swords/entity_effects
advancement revoke @s only tcc:technical/item/player_with_tipped_sword
function tcc:item/item_modification/durability/damage/tipped_swords/damage
