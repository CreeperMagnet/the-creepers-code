...
execute unless entity @s[tag=tcc.break] run item entity @s weapon.mainhand modify tcc:durability_lore
...
execute unless entity @s[tag=tcc.break] run item entity @s weapon.mainhand modify tcc:copy_nbt
execute if entity @s[tag=tcc.break] run item entity @s weapon.mainhand replace air
