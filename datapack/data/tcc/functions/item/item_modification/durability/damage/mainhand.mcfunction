...
execute unless entity @s[tag=tcc.break] run item modify entity @s weapon.mainhand tcc:durability_lore
execute unless entity @s[tag=tcc.break] run data modify storage tcc:storage root.temp.item set from entity @s SelectedItem
...
execute unless entity @s[tag=tcc.break] run item modify entity @s weapon.mainhand tcc:copy_nbt
execute if entity @s[tag=tcc.break] run item replace entity @s weapon.mainhand with air
