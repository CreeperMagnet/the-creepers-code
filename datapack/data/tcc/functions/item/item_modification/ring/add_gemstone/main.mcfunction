...
execute unless data storage tcc:storage root.temp.item.tag.tcc.potion{custom_name:1} run data modify storage tcc:storage root.temp.default_name set value 1
function #tcc:dynamic_rings/material_checks/add_gemstone

data modify storage tcc:storage root.temp.item.tag.tcc.gemstone.quality set from storage tcc:storage root.temp.gemstone.quality
data modify storage tcc:storage root.temp.item.tag.tcc.gemstone.id set from storage tcc:storage root.temp.gemstone.id
execute if data storage tcc:storage root.temp.item.tag.tcc.potion run data modify storage tcc:storage root.temp.item.tag.tcc.potion.custom_name set value 1
