...
execute if entity @s[nbt={SelectedItem:{tag:{tcc:{id:"locket_of_learning"}}}}] run data modify storage tcc:storage root.temp.Items insert 0 from entity @s SelectedItem
execute if entity @s[nbt=!{SelectedItem:{tag:{tcc:{id:"locket_of_learning"}}}},nbt={Inventory:[{tag:{tcc:{id:"locket_of_learning"}},Slot:-106b}]}] run data modify storage tcc:storage root.temp.Items insert 0 from entity @s Inventory[{Slot:-106b}]
data remove storage tcc:storage root.temp.Items[0].Slot

# store current locket/xp level to score, for operations
execute store result score @s tcc.dummy run data get storage tcc:storage root.temp.Items[0].tag.tcc.stored_points
...
data remove storage tcc:storage root.temp.Items
