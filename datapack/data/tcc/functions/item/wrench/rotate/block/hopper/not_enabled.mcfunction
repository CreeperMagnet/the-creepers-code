...
execute if entity @s[scores={tcc.dummy=0}] store result score @s tcc.dummy if block ~ ~ ~ hopper[facing=west] run setblock ~ ~ ~ hopper[facing=down,enabled=false]
execute if entity @s[scores={tcc.dummy=0}] store result score @s tcc.dummy if block ~ ~ ~ hopper[facing=down] run setblock ~ ~ ~ hopper[facing=north,enabled=false]