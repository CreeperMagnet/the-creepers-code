...
execute if block ~ ~ ~ minecraft:birch_sign run function tcc:item/wrench/rotate/macro/rotation_waterloggable {block:"minecraft:birch_sign"}
execute if block ~ ~ ~ minecraft:cherry_sign run function tcc:item/wrench/rotate/macro/rotation_waterloggable {block:"minecraft:cherry_sign"}
execute if block ~ ~ ~ minecraft:crimson_sign run function tcc:item/wrench/rotate/macro/rotation_waterloggable {block:"minecraft:crimson_sign"}
execute if block ~ ~ ~ minecraft:dark_oak_sign run function tcc:item/wrench/rotate/macro/rotation_waterloggable {block:"minecraft:dark_oak_sign"}
