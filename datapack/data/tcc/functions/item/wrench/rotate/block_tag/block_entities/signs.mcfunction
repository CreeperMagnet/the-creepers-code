...
execute if block ~ ~ ~ mangrove_sign run function tcc:item/wrench/rotate/block/mangrove_sign/main
...
data modify block ~ ~ ~ GlowingText set from storage tcc:storage root.temp.wrench_block_data.GlowingText
