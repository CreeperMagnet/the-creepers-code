...
execute if block ~ ~ ~ mangrove_fence_gate run function tcc:item/wrench/rotate/block/mangrove_fence_gate
execute if block ~ ~ ~ oak_fence_gate run function tcc:item/wrench/rotate/block/oak_fence_gate
execute if block ~ ~ ~ spruce_fence_gate run function tcc:item/wrench/rotate/block/spruce_fence_gate
execute if block ~ ~ ~ warped_fence_gate run function tcc:item/wrench/rotate/block/warped_fence_gate
