...
execute as @a[tag=tcc.scheduled.nibbled_apple_pie.offhand,nbt={Inventory:[{Slot:-106b}]}] run loot give @s loot tcc:items/apple_pie_slice
...
execute as @a[tag=tcc.scheduled.nibbled_apple_pie.mainhand,nbt={SelectedItem:{}}] run loot give @s loot tcc:items/apple_pie_slice
