...
execute as @a[tag=tcc.scheduled.apple_pie.offhand,nbt={Inventory:[{Slot:-106b}]}] run loot give @s loot tcc:items/nibbled_apple_pie
...
execute as @a[tag=tcc.scheduled.apple_pie.mainhand,nbt={SelectedItem:{}}] run loot give @s loot tcc:items/nibbled_apple_pie
