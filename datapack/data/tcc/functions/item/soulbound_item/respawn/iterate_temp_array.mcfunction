...
execute unless score @s tcc.dummy matches 0 run data modify storage tcc:storage root.temp.new_dropped_soulbound_items append from storage tcc:storage root.temp.dropped_soulbound_items[0]
data remove storage tcc:storage root.temp.dropped_soulbound_items[0]
execute if data storage tcc:storage root.temp.dropped_soulbound_items[0] run function tcc:item/soulbound_item/respawn/iterate_temp_array