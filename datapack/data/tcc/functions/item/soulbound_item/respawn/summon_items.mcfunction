...
summon item ~ ~ ~ {Tags:["tcc.newly_spawned_soulbound_item"],Item:{id:"minecraft:stone",Count:1b}}
execute as @e[limit=1,tag=tcc.newly_spawned_soulbound_item,type=item] run function tcc:item/soulbound_item/respawn/as_item
