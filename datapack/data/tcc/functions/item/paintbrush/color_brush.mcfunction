...
scoreboard players add tcc.temp_2 tcc.dummy 330010
execute store result storage tcc:storage root.temp.item.tag.CustomModelData int 1 run scoreboard players get tcc.temp_2 tcc.dummy
