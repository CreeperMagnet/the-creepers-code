...
execute if entity @s[scores={tcc.dummy=..499}] positioned ~-0.01 ~-0.99 ~-0.01 as @e[dx=0,dz=0,dy=0,type=painting,tag=!global.ignore,tag=!global.ignore.kill] positioned ~-0.99 ~0.99 ~-0.99 if entity @s[dx=0,dz=0,dy=0] run tag @p[tag=tcc.paintbrush_raycaster] add tcc.tag
...
execute if entity @s[tag=tcc.tag] positioned ~-0.01 ~-0.99 ~-0.01 as @e[dx=0,dz=0,dy=0,type=painting,tag=!global.ignore,tag=!global.ignore.kill] positioned ~-0.99 ~0.99 ~-0.99 at @s[dx=0,dz=0,dy=0] run function tcc:item/paintbrush/painting_cycle/discern
