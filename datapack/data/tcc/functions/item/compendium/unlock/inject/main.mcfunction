...
$execute unless data storage tcc:temp root.compendium{unlocked_entries:["$(entry_name)"]} run data modify storage tcc:temp root.compendium.unlocked_entries append from storage tcc:temp root.start_injection.entry_name
