...
scoreboard players enable @s[predicate=tcc:entity/holding/compendium] tccc.internal_trigger
# Revoke compendium changing rights if the player is no longer holding it
execute unless predicate tcc:entity/holding/compendium run tag @s remove tcc.can_change_compendium_mode
# Reset trigger score
