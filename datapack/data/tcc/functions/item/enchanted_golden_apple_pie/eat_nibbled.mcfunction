############################################################
# Description: Makes enchanted golden apple pie halves work
# Creator: ChromaKey
############################################################

advancement revoke @s only tcc:technical/item/nibbled_enchanted_golden_apple_pie
...
schedule function tcc:item/enchanted_golden_apple_pie/insert_slice 1t
