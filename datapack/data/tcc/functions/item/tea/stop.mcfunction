...
execute if entity @s[tag=tcc.tea.illumination] run title @s actionbar {"translate":"potion.withDuration","color":"red","with":[{"translate":"item.tcc.illumination_tea.title","color":"white","font":"tcc:tea"},{"translate":"potion.tcc.duration","with":[0,0,0]}]}
