...
execute unless entity @s[advancements={tcc:technical/consume_item/tea={illumination=false,illumination_extended=false}}] unless entity @s[tag=tcc.tea.illumination,scores={tcc.tea=301..}] run function tcc:item/tea/drink/illumination
