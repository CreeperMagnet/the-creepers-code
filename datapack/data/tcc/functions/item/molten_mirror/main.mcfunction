############################################################
# Makes molten mirrors flip effects
############################################################
...
data remove storage tcc:storage root.temp.effects[{Id:6}]
data remove storage tcc:storage root.temp.effects[{Id:7}]
data remove storage tcc:storage root.temp.effects[{Id:23}]
data remove storage tcc:storage root.temp.effects[{Id:29}]
data remove storage tcc:storage root.temp.effects[{Id:31}]
data remove storage tcc:storage root.temp.effects[{Id:32}]
execute if data storage tcc:storage root.temp.effects[0] run function tcc:item/molten_mirror/flip
