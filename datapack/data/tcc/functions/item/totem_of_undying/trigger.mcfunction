...
effect give @s[predicate=tcc:entity/holding/totem_of_undying,advancements={tcc:technical/multiple_trigger_types/totem_of_undying={void_damage=true}},nbt=!{ActiveEffects:[{Id:25b}]}] instant_damage 1 100 true
