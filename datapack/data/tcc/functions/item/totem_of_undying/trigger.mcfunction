...
effect give @s[predicate=tcc:entity/holding/totem_of_undying,advancements={tcc:technical/multiple_trigger_types/totem_of_undying={void_damage=true}},nbt=!{active_effects:[{id:"minecraft:levitation"}]}] instant_damage 1 100 true
