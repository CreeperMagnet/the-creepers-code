...
advancement revoke @s only tcc:technical/item/quest_book/healer/trigger/01
execute if entity @s[tag=tcc.quest.healer,advancements={tcc:technical/item/quest_book/healer/display/01=false}] run function tcc:item/quest_book/healer/toast
advancement grant @s[tag=tcc.quest.healer] only tcc:technical/item/quest_book/healer/display/01
