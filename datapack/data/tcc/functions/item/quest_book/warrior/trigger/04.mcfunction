...
advancement revoke @s only tcc:technical/item/quest_book/warrior/trigger/04
execute if entity @s[tag=tcc.quest.warrior,advancements={tcc:technical/item/quest_book/warrior/display/04=false}] run function tcc:item/quest_book/warrior/toast
advancement grant @s[tag=tcc.quest.warrior] only tcc:technical/item/quest_book/warrior/display/04
