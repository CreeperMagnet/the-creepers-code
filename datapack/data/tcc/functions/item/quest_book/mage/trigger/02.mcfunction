...
advancement revoke @s only tcc:technical/item/quest_book/mage/trigger/02
execute if entity @s[tag=tcc.quest.mage,advancements={tcc:technical/item/quest_book/mage/display/02=false}] run function tcc:item/quest_book/mage/toast
advancement grant @s[tag=tcc.quest.mage] only tcc:technical/item/quest_book/mage/display/02
