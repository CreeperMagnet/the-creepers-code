...
advancement revoke @s only tcc:technical/item/quest_book/rogue/trigger/04
execute if entity @s[tag=tcc.quest.rogue,advancements={tcc:technical/item/quest_book/rogue/display/04=false}] run function tcc:item/quest_book/rogue/toast
advancement grant @s[tag=tcc.quest.rogue] only tcc:technical/item/quest_book/rogue/display/04
