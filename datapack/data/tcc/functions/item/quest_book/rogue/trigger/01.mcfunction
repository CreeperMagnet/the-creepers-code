...
advancement revoke @s only tcc:technical/item/quest_book/rogue/trigger/01
execute if entity @s[tag=tcc.quest.rogue,advancements={tcc:technical/item/quest_book/rogue/display/01=false}] run function tcc:item/quest_book/rogue/toast
advancement grant @s[tag=tcc.quest.rogue] only tcc:technical/item/quest_book/rogue/display/01
