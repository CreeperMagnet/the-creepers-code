...
execute if entity @s[scores={tcc.dummy2=1..}] positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!#tcc:boomerang_ignore,dx=0,dz=0,dy=0,distance=..5,predicate=tcc:global.ignore,nbt={HurtTime:0s}] run effect give @s glowing 10 0 false
