...
execute if entity @s[type=minecraft:boat,nbt={Type:"bamboo"}] run summon item ~ ~ ~ {Motion:[0.0d,0.2d,0.2d],Item:{id:"minecraft:bamboo_raft",Count:1b}}
...
execute if entity @s[type=minecraft:boat,nbt={Type:"cherry"}] run summon item ~ ~ ~ {Motion:[0.0d,0.2d,0.2d],Item:{id:"minecraft:cherry_boat",Count:1b}}
...
execute if entity @s[type=minecraft:chest_boat,nbt={Type:"bamboo"}] run summon item ~ ~ ~ {Motion:[0.0d,0.2d,0.2d],Item:{id:"minecraft:bamboo_chest_raft",Count:1b}}
...
execute if entity @s[type=minecraft:chest_boat,nbt={Type:"cherry"}] run summon item ~ ~ ~ {Motion:[0.0d,0.2d,0.2d],Item:{id:"minecraft:cherry_chest_boat",Count:1b}}
