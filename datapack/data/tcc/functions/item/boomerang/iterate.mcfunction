...
execute if entity @s[scores={tcc.dummy2=2..}] positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!#tcc:boomerang/ignore,dx=0] at @s run function tcc:item/boomerang/entity_interaction/main with storage tcc:temp root.boomerang.macro_input
