...
execute if score tcc.temp_1 tcc.dummy matches 0 run function tcc:worldgen/bootleg_jigsaw/ocean_ruin_addition/warm/setblock_treasure
execute if score tcc.temp_1 tcc.dummy matches 1 run function tcc:worldgen/bootleg_jigsaw/ocean_ruin_addition/warm/setblock_trident
