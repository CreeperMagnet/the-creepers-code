...
execute if data storage tcc:storage root.temp.snail_bucket.tag.display{Name:'"Gary"'} run function tcc:entity/snail/summon/set_variant/gary
execute unless data storage tcc:storage root.temp.snail_bucket.tag.display{Name:'{"translate":"item.tcc.snail_bucket","italic":false}'} run data modify entity @s CustomName set from storage tcc:storage root.temp.snail_bucket.tag.display.Name
