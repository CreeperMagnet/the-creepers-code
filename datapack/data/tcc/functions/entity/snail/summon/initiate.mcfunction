############################################################
# Description: Initiates the proper data for a newly spawned snail
# Creator: CreeperMagnet_
############################################################

scoreboard players set @s tcc.dummy 0
tp @s ~0.5 ~ ~0.5
execute as @s[scores={tcc.dummy=0}] at @s store success score @s tcc.dummy if predicate tcc:chance/one_half run tp @s ~0.2 ~ ~
execute as @s[scores={tcc.dummy=0}] at @s store success score @s tcc.dummy if predicate tcc:chance/one_half run tp @s ~ ~ ~0.2
execute as @s[scores={tcc.dummy=0}] at @s store success score @s tcc.dummy if predicate tcc:chance/one_half run tp @s ~-0.2 ~ ~
execute as @s[scores={tcc.dummy=0}] at @s store success score @s tcc.dummy if predicate tcc:chance/one_half run tp @s ~ ~ ~-0.2
execute store result score @s tcc.dummy run data get entity @s UUID[0]
scoreboard players operation @s tcc.dummy %= tcc.const.180 tcc.dummy
