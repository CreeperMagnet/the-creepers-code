...
execute if entity @s[tag=tcc.pregnant] at @s align xyz positioned ~0.5 ~-0.5 ~0.5 if block ~ ~ ~ clay unless entity @e[distance=..0.5,tag=smithed.block] run function tcc:entity/snail/breed/lay_egg/loop
