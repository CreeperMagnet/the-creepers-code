...
execute as @e[type=minecraft:wandering_trader,distance=0.0001..5,tag=tcc.in_love,tag=tcc.snail,sort=nearest,limit=1] at @s run function tcc:entity/snail/breed/find_mate
