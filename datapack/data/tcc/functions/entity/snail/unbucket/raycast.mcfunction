...
execute unless block ^ ^ ^0.01 #tcc:raycast_ignore unless block ^ ^ ^0.01 #cauldrons align xyz if block ~ ~ ~ #tcc:raycast_ignore if block ~ ~1 ~ #tcc:snail_survivable unless block ~ ~ ~ lava unless block ~ ~ ~ water unless block ~ ~ ~ powder_snow run function tcc:entity/snail/unbucket/summon
