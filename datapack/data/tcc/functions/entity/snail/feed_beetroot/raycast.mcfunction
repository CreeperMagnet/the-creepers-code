...
execute if entity @s[scores={tcc.dummy=..499},tag=!tcc.tag] positioned ^ ^ ^0.01 run function tcc:entity/snail/feed_beetroot/raycast
execute if entity @s[scores={tcc.dummy=..499},tag=tcc.tag] run function tcc:entity/snail/feed_beetroot/player_finish
