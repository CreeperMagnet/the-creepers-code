...
loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/wandering_witch/buy_trade_spider_eye
function tcc:entity/wandering_witch/add_trade


loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/wandering_witch/buy_trade_fermented_spider_eye
function tcc:entity/wandering_witch/add_trade
...
loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/wandering_witch/explorer_map
function tcc:entity/wandering_witch/add_trade
