...
execute if score tcc.damage tcc.dummy >= @s tcc.dummy2 run function tcc:entity/player/damage/death
scoreboard players operation @s tcc.dummy -= @s tcc.dummy2
scoreboard players operation @s tcc.dummy += tcc.damage tcc.dummy
