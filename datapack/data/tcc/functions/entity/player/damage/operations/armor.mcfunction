...
# #damage tcc.dummy: damage to add to entity, to 1 decimal place (x10)
...
scoreboard players operation #temp_2 tcc.dummy = #temp_0 tcc.dummy
scoreboard players operation #temp_2 tcc.dummy /= #5 tcc.dummy
 ...
 ##### SEPARATOR SO YOUR BRAIN DOESN'T MELT
  ...
  # Armor
scoreboard players operation #temp_3 tcc.dummy = #temp_0 tcc.dummy
  # Damage
scoreboard players operation #temp_4 tcc.dummy = #damage tcc.dummy
  # Armor Toughness
scoreboard players operation #temp_5 tcc.dummy = #temp_1 tcc.dummy


  # Divide by 4 (working inside -> out), so (toughness ÷ 4) first.
  # #4 always has the value of 4.

scoreboard players operation #temp_5 tcc.dummy /= #4 tcc.dummy


  # Then we add 2 to that, again working inside -> out. (2 + (toughness ÷ 4))

scoreboard players add #temp_5 tcc.dummy 20


  # Then, divide the damage by that value. (damage ÷ (2 + (toughness ÷ 4)))

scoreboard players operation #temp_4 tcc.dummy /= #temp_5 tcc.dummy
scoreboard players operation #temp_4 tcc.dummy *= #10 tcc.dummy

  # Then subtract that value from armor, and you have the final result of the armor toughness formula.

scoreboard players operation #temp_3 tcc.dummy -= #temp_4 tcc.dummy
...
execute if score #temp_3 tcc.dummy > #temp_2 tcc.dummy run scoreboard players operation #temp_2 tcc.dummy = #temp_3 tcc.dummy
...
execute if score #temp_2 tcc.dummy matches 200.. run scoreboard players set #temp_2 tcc.dummy 200
...
scoreboard players operation #temp_2 tcc.dummy /= #25 tcc.dummy
