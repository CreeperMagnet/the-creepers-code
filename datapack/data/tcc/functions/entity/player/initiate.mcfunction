...
execute unless entity @s[scores={tcc.dummy2=0}] run title @s[tag=!global.ignore.gui] title {"translate":"commands.tcc.initiate.wrong_version.title","color":"red","bold":true}
