...
execute unless data storage tcc:storage root.temp.compendium run tag @s add tcc.unlockable_compendium
execute unless data storage tcc:storage root.temp.compendium run function tcc:item/compendium/give
execute if data storage tcc:storage root.temp.compendium run function tcc:item/compendium/check_unlock_list/main
execute if data storage tcc:storage root.temp.compendium run function tcc:item/compendium/refresh
