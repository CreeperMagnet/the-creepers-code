...
tellraw @s {"translate":"The Creeper's Code Resource Pack is not installed. Please go to https://thecreeperscode.com/download.","with":[{"translate":"commands.tcc.initiate","hoverEvent":{"action":"show_text","contents":{"translate":"commands.tcc.initiate.hover_event"}},"clickEvent":{"action":"open_url","value":"https://thecreeperscode.com/help"},"with":[{"translate":"pack.tcc","color":"#008725","underlined":true,"hoverEvent":{"action":"show_text","contents":{"translate":"pack.tcc.hover_event"}},"clickEvent":{"action":"open_url","value":"https://thecreeperscode.com"}},{"translate":"pack.tcc.version","color":"green","underlined":true,"hoverEvent":{"action":"show_text","contents":{"translate":"pack.tcc.version.hover_event"}},"clickEvent":{"action":"open_url","value":"https://thecreeperscode.com/development/1-0-1-changelog"}}]}]}

scoreboard players set @s tcc.dummy 2975
...
execute unless data storage tcc:storage root.gamerules.generateMonuments as @s[scores={tcc.dummy=..72000}] run data modify storage tcc:storage root.gamerules.generateMonuments set value 1b
execute unless data storage tcc:storage root.gamerules.generateMonuments as @s[scores={tcc.dummy=72000..}] run tellraw @s [{"text":"\n"},{"translate":"commands.tcc.monument_generation_prompt: This datapack's ocean monument edits have been disabled since you have added this datapack to an already existing world. Please click this message and run the suggested command if you want to re-enable them. Re-enabling may cause destruction of player builds in and around existing ocean monuments.","color":"red","clickEvent":{"action":"suggest_command","value":"/data modify storage tcc:storage root.gamerules.generateMonuments set value 1b"}}]
execute unless data storage tcc:storage root.gamerules.generateMonuments as @s[scores={tcc.dummy=72000..}] run data modify storage tcc:storage root.gamerules.generateMonuments set value 0b
