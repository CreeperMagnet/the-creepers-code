...
scoreboard players set @s tcc.dummy 2712
...
execute unless entity @s[scores={tcc.dummy2=0}] run tellraw @s {"translate":"commands.tcc.initiate.wrong_version","color":"red","bold":true}
