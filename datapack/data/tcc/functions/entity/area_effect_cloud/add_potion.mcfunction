...
execute store success score @s[scores={tcc.dummy=0}] tcc.dummy as @e[type=item,tag=!global.ignore,sort=arbitrary,predicate=tcc:unpotioned_item,dx=4,dz=4,dy=1,nbt=!{Item:{tag:{tcc:{id:"ring"}}}}] run function tcc:entity/area_effect_cloud/tip_sword
