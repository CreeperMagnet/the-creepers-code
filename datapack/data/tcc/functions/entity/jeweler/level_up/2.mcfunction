...
# Trade 3
loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/jeweler/trade_3
...
# Trade 4
loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/jeweler/trade_4
