...
# Trade 8
loot replace entity @s weapon.mainhand 2 loot tcc:gameplay/trades/jeweler/trade_8/buy
...
loot replace entity @s weapon.mainhand 1 loot tcc:gameplay/trades/jeweler/trade_8/sell
