...
data modify entity @s[tag=!tcc.spellcasting,tag=!tcc.trader_entity.static,predicate=tcc:entity/moving,predicate=!tcc:entity/in_vehicle] HandItems[0].tag.CustomModelData set from entity @s ArmorItems[3].tag.tcc.custom_model_data.moving
