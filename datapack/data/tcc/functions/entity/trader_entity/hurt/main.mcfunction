...
execute store result entity @s HandItems[0].components."minecraft:custom_model_data" int 1 run scoreboard players get @s tcc.dummy
...
scoreboard players add @s tcc.dummy 1
execute store result entity @s ArmorItems[3].components."minecraft:custom_model_data" int 1 run scoreboard players get @s tcc.dummy
