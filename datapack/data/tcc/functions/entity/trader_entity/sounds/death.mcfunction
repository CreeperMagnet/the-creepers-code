...
execute if entity @s[nbt={Item:{tag:{tcc:{entity:"wandering_witch"}}}}] run playsound tcc:entity.wandering_witch.death neutral @a[distance=..16]
execute unless entity @s[nbt=!{Item:{tag:{tcc:{entity:"snail"}}}},tag=!tcc.snail] run playsound tcc:entity.snail.hurt neutral @a[distance=..16]
