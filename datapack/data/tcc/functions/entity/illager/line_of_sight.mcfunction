...
execute anchored eyes facing entity @e[predicate=tcc:entity_properties/targeted_by_illagers,limit=1,distance=..16,sort=nearest] eyes run function tcc:entity/illager/line_of_sight_raycast
