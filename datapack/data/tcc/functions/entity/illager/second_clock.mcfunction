...
execute if entity @s[tag=!tcc.spellcasting] unless entity @s[tag=!tcc.iceologer,tag=!tcc.geomancer] if entity @e[predicate=tcc:entity_properties/targeted_by_illagers,limit=1,distance=..16,sort=nearest] run function tcc:entity/illager/line_of_sight
