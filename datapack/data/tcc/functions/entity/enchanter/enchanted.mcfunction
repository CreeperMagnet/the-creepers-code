...
execute if score #temp_0 tcc.dummy matches 1 run effect give @s strength 20 1
execute if score #temp_0 tcc.dummy matches 1 run data modify entity @s ActiveEffects[{Id:5}].Ambient set value 1
execute if score #temp_0 tcc.dummy matches 2 run effect give @s speed 20 1
execute if score #temp_0 tcc.dummy matches 2 run data modify entity @s ActiveEffects[{Id:1}].Ambient set value 1
execute if score #temp_0 tcc.dummy matches 3 run effect give @s resistance 20 1
