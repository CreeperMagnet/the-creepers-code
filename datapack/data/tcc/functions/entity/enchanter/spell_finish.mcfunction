...
execute as @e[sort=random,distance=..10,predicate=tcc:entity/enchanter_affected,tag=!tcc.enchanter,limit=1,nbt=!{ActiveEffects:[{Ambient:1b}]}] at @s run function tcc:entity/enchanter/enchanted
