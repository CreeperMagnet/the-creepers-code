...
execute as @e[sort=random,distance=..10,team=tcc.antivillager,tag=!tcc.enchanter,predicate=tcc:global.ignore,limit=1,nbt=!{ActiveEffects:[{Ambient:1b}]}] at @s run function tcc:entity/enchanter/enchanted