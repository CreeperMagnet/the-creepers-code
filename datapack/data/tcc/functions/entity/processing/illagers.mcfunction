...
execute if entity @s[predicate=tcc:entity/spawning/iceologer_biomes,predicate=tcc:chance/one_tenth] if data entity @s RaidId run function tcc:commands/summon/iceologer
