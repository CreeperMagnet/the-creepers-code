...
execute if entity @s[type=minecraft:zombie,predicate=tcc:location_check/below_0,predicate=tcc:random_chance/0.1] if dimension minecraft:overworld unless entity @a[distance=..20] run data merge entity @s {Tags:["tcc.glow_lichen_zombie","tcc.burns_in_sunlight","tcc.ten_second_clock"],DeathLootTable:"tcc:entities/glow_lichen_zombie",HandItems:[{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330020}},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330020}}],ArmorItems:[{},{},{},{id:"minecraft:structure_block",count:1,components:{"minecraft:custom_model_data":330021}}],ArmorDropChances:[-10000.0f,-10000.0f,-10000.0f,-10000.0f],HandDropChances:[-10000.0f,-10000.0f]}
execute if entity @s[type=minecraft:witch,predicate=tcc:location_check/below_0] run function tcc:entity/geomancer/spawn
...
execute if entity @s[type=#minecraft:illager] run function tcc:entity/processing/illagers
