...
summon wandering_trader ~ ~ ~ {Offers:{Recipes:[]},Team:"smithed.prevent_aggression",CustomName:'{"translate":"entity.minecraft.witch"}',DeathLootTable:"minecraft:entities/witch",ArmorDropChances:[-10000.0f,-10000.0f,-10000.0f,-10000.0f],HandDropChances:[-10000.0f,-10000.0f],ActiveEffects:[{Id:14b,Duration:100000,Amplifier:0b,ShowParticles:0b}],Tags:["tcc.witch_trader","tcc.tick","tcc.second_clock","tcc.ten_second_clock","tcc.trader_entity","smithed.entity","tcc.witch_trader.newly_spawned"],Silent:1b,ArmorItems:[{},{id:"minecraft:structure_block",Count:1b,tag:{witch_data:{},CustomModelData:330000}},{},{id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:330066,tcc:{custom_model_data:{head:330066,idle:330068,moving:330070}}}}],HandItems:[{id:"minecraft:structure_block",Count:1b,tag:{CustomModelData:330068}}],Attributes:[{Name:"generic.max_health",Base:26d}]}
