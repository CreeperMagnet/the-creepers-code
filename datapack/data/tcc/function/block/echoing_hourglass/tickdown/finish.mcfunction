...
execute on passengers if entity @s[tag=tcc.echoing_hourglass.sand_top] run data modify entity @s transformation.scale set value [0.999f,1.0f,0.999f]
execute on passengers if entity @s[tag=tcc.echoing_hourglass.sand_bottom] run data modify entity @s transformation.scale set value [0.999f,0.001f,0.999f]
