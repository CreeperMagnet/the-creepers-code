...
particle minecraft:item{item:{id:"minecraft:tinted_glass",components:{"minecraft:item_model":"tcc:block/echoing_hourglass/glass","minecraft:custom_model_data":{strings:["empty"]}}}} ~ ~1 ~ 0.3 0.4 0.3 0.05 20 normal
