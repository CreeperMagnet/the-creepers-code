...
particle minecraft:item{item:{id:"minecraft:tinted_glass",components:{"minecraft:item_model":"tcc:block/echoing_hourglass/glass","minecraft:custom_model_data":{"strings":["empty"]}}}} ~ ~0.5 ~ 0.2 0.3 0.2 0 15 normal
