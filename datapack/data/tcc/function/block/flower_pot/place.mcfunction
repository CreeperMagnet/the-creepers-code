...
execute unless predicate tcc:entity_properties/slots/weapon.mainhand/custom_flower_pot run data modify storage tcc:temp root.macro_input.type set from entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".tcc.type
