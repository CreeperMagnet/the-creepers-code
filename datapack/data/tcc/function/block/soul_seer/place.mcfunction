...
setblock ~ ~ ~ minecraft:dropper[facing=down,triggered=false]{CustomName:'{"font":"tcc:technical","translate":"block.tcc.soul_seer.name"}',lock:{"components":{"minecraft:custom_data":{"tcc":{soul_seer:1b}}}}}
