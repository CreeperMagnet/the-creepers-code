...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {translation:"weakness",color:"red",effect:"weakness",duration_0:0,duration_1:9,amplifier:0}
