...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:4738376,translation:"weakness",lore_color:"red",effect:"weakness",duration:9,duration_lore_0:0,duration_lore_1:9,amplifier:0}
