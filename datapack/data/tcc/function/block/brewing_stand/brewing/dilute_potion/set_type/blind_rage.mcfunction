...
data modify storage tcc:temp root.item.components."minecraft:lore" prepend value {"color":"blue","italic":false,"translate":"potion.withDuration","with":[{"translate":"potion.withAmplifier","with":[{"translate":"effect.minecraft.strength"},{"translate":"potion.potency.4"}]},{"translate":"potion.tcc.duration","with":["0","0","0","2"]}]}
