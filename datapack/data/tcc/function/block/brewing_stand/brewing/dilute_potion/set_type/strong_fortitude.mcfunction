...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:16738851,translation:"fortitude",lore_color:"blue",effect:"health_boost",duration_0:0,duration_1:9,amplifier:1}
