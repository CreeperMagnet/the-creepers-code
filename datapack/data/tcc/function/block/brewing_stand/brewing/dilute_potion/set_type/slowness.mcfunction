...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:9154528,translation:"slowness",lore_color:"red",effect:"slowness",duration_0:0,duration_1:9,amplifier:0}
