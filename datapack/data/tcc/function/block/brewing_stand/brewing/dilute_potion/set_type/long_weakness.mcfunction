...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:4738376,translation:"weakness",lore_color:"red",effect:"weakness",duration:24,duration_lore_0:2,duration_lore_1:4,amplifier:0}
