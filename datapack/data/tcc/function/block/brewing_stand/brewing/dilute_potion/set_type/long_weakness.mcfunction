...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {translation:"weakness",color:"red",effect:"weakness",duration_0:2,duration_1:4,amplifier:0}
