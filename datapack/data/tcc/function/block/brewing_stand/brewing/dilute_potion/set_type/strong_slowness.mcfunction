...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {translation:"slowness",color:"red",effect:"slowness",duration_0:0,duration_1:2,amplifier:3}
