...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:5882118,translation:"luck",lore_color:"blue",effect:"luck",duration:30,duration_lore_0:3,duration_lore_1:0,amplifier:0}
