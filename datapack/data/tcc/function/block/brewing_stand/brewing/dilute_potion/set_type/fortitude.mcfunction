...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:16738851,translation:"tcc:fortitude",lore_color:"blue",effect:"health_boost",duration_0:1,duration_1:8,amplifier:0}
