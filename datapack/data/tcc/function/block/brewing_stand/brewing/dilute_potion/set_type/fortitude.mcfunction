...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:16738851,translation:"tcc:fortitude",lore_color:"blue",effect:"health_boost",duration:18,duration_lore_0:1,duration_lore_1:8,amplifier:0}
