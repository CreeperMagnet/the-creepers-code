...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:16762624,translation:"strength",lore_color:"blue",effect:"strength",duration_0:1,duration_1:8,amplifier:0}
