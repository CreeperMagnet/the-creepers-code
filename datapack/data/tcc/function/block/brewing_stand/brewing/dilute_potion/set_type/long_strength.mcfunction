...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:16762624,translation:"strength",lore_color:"blue",effect:"strength",duration:48,duration_lore_0:4,duration_lore_1:8,amplifier:0}
