...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {translation:"strength",color:"blue",effect:"strength",duration_0:4,duration_1:8,amplifier:0}
