...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {translation:"swiftness",color:"blue",effect:"speed",duration_0:1,duration_1:8,amplifier:0}
