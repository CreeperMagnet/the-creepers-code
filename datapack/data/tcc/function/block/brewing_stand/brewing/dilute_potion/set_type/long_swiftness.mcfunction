...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:3402751,translation:"swiftness",lore_color:"blue",effect:"speed",duration:48,duration_lore_0:4,duration_lore_1:8,amplifier:0}
