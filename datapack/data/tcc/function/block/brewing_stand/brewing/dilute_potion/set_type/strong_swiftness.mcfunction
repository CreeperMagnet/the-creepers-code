...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:3402751,translation:"swiftness",lore_color:"blue",effect:"speed",duration_0:0,duration_1:9,amplifier:1}
