...
function tcc:block/brewing_stand/brewing/dilute_potion/set_generic_tags {color:9154528,translation:"slowness",lore_color:"red",effect:"slowness",duration_0:2,duration_1:4,amplifier:0}
