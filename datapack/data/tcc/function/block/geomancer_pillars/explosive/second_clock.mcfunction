...
execute if entity @s[scores={tcc.dummy2=1}] run data modify entity @s item.components."minecraft:item_model" set value "tcc:block/geomancer_pillar/explosive_lit"
