...
execute if entity @s[scores={tcc.dummy2=1}] run data modify entity @s item.components."minecraft:custom_model_data" set value 330087
execute if entity @s[scores={tcc.dummy2=3}] run function tcc:block/geomancer_pillars/explosive/explode
execute if entity @s[scores={tcc.dummy2=3}] run particle minecraft:item{item:{id:"minecraft:structure_block",components:{"minecraft:custom_model_data":330006}}} ~ ~1 ~ 0.5 1 0.5 0.1 100 normal
