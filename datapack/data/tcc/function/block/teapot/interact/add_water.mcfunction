...
execute on vehicle run data modify entity @s item set value {id:"minecraft:leather_horse_armor",count:1,components:{"minecraft:custom_data":{tea:{id:"water",color:3760074,extended:0b}},"minecraft:custom_model_data":330000,"minecraft:dyed_color":{rgb:3760074}}}
