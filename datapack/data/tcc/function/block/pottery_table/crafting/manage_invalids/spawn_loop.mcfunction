...
execute unless entity @a[tag=tcc.inside_pottery_table_gui,gamemode=!spectator] positioned ~ ~1 ~ run function tcc:technical/macros/spawn_item with storage tcc:temp root.macro_input
