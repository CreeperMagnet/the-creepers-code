...
## Fishing bobbers
execute if entity @s[type=minecraft:fishing_bobber] if predicate tcc:location_check/in_water run function tcc:entity/fishing_bobber/check_treasure

## Loyalty tridents returning from the void
execute if entity @s[type=minecraft:trident] if predicate tcc:location_check/in_void run data modify entity @s DealtDamage set value 1b
