...
execute unless predicate tcc:entity_properties/slots/weapon.mainhand/reactive_seeker run data modify storage tcc:temp root.macro_input set value {slot:"weapon.offhand",slot_raw:"Inventory[{Slot:-106b}]"}
