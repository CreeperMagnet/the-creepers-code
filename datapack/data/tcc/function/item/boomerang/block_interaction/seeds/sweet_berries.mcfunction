...
particle minecraft:block{block_state:{Name:"minecraft:sweet_berry_bush",Properties:{age:"2"}}} ~ ~1 ~ 0.1 0.1 0.1 0 15
playsound minecraft:block.sweet_berry_bush.break block @a[distance=..16]
loot spawn ~ ~ ~ loot tcc:blocks/boomerang/sweet_berries