...
execute unless predicate tcc:entity_properties/slots/weapon.mainhand/riftjuice_bottle store result storage tcc:temp root.riftjuice.id int 1 run data get entity @s equipment.offhand.components."minecraft:custom_data".tcc.riftjuice_id
