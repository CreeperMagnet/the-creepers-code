...
execute if entity @s[nbt={variant:"minecraft:kebab"}] run return run data modify entity @s variant set value "minecraft:meditative"
execute if entity @s[nbt={variant:"minecraft:meditative"}] run return run data modify entity @s variant set value "minecraft:plant"
