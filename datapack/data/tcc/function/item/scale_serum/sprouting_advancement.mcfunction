...
# Add 0.167 to scale
execute store result score @s tcc.dummy run attribute @s minecraft:scale modifier value get tcc:scale_serum 1000
...
execute store result score @s tcc.dummy run attribute @s minecraft:jump_strength modifier value get tcc:scale_serum 100
...
execute store result score @s tcc.dummy run attribute @s minecraft:entity_interaction_range modifier value get tcc:scale_serum 10
...
execute store result score @s tcc.dummy run attribute @s minecraft:block_interaction_range modifier value get tcc:scale_serum 10
...
execute store result score @s tcc.dummy run attribute @s minecraft:safe_fall_distance modifier value get tcc:scale_serum 10
