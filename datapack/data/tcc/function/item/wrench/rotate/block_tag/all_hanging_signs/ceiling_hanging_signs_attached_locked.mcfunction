...
execute if block ~ ~ ~ minecraft:pale_oak_hanging_sign run function tcc:item/wrench/rotate/macro/hanging_signs/locked_rotation/main {block:"minecraft:pale_oak_hanging_sign",attached:"true"}
