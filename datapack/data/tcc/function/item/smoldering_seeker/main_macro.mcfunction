...
$loot replace entity @s $(slot) loot tcc:technical/map/smoldering_seeker
...
data merge storage tcc:temp {root:{item:{id:"minecraft:compass",count:1,components:{"minecraft:lodestone_tracker":{target:{pos:[0,60,0],dimension:"minecraft:the_nether"},tracked:0b},"minecraft:item_model":"tcc:smoldering_seeker/main","minecraft:custom_name":"{\"translate\":\"item.tcc.smoldering_seeker\",\"italic\":false}","minecraft:max_stack_size":1}}}}
