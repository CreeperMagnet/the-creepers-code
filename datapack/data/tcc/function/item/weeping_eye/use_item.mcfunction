...
execute unless predicate tcc:entity_properties/slots/weapon.mainhand/weeping_eye run data modify storage tcc:temp root.macro_input set value {slot:"weapon.offhand",slot_raw:"equipment.offhand"}
