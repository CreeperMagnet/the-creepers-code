...
data merge storage tcc:temp {root:{item:{id:"minecraft:poisonous_potato",count:1,components:{"minecraft:lodestone_tracker":{target:{pos:[0,60,0],dimension:"minecraft:the_end"},tracked:0b},"!minecraft:consumable":{}}}}}
