...
$loot replace entity @s $(slot) loot tcc:technical/map/weeping_eye
...
data merge storage tcc:temp {root:{item:{id:"minecraft:compass",count:1,components:{"minecraft:lodestone_tracker":{target:{pos:[0,60,0],dimension:"minecraft:the_end"},tracked:0b},"minecraft:item_model":"tcc:weeping_eye/main","minecraft:custom_name":"{\"translate\":\"item.tcc.weeping_eye\",\"italic\":false}","minecraft:max_stack_size":1}}}}
