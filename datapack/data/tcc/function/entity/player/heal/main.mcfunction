...
attribute @s[scores={tcc.dummy=128..}] minecraft:max_health modifier add tcc:healing_128 -12.8 add_value
scoreboard players remove @s[scores={tcc.dummy=128..}] tcc.dummy 128
attribute @s[scores={tcc.dummy=64..}] minecraft:max_health modifier add tcc:healing_64 -6.4 add_value
scoreboard players remove @s[scores={tcc.dummy=64..}] tcc.dummy 64
attribute @s[scores={tcc.dummy=32..}] minecraft:max_health modifier add tcc:healing_32 -3.2 add_value
scoreboard players remove @s[scores={tcc.dummy=32..}] tcc.dummy 32
attribute @s[scores={tcc.dummy=16..}] minecraft:max_health modifier add tcc:healing_16 -1.6 add_value
scoreboard players remove @s[scores={tcc.dummy=16..}] tcc.dummy 16
attribute @s[scores={tcc.dummy=8..}] minecraft:max_health modifier add tcc:healing_8 -0.8 add_value
scoreboard players remove @s[scores={tcc.dummy=8..}] tcc.dummy 8
attribute @s[scores={tcc.dummy=4..}] minecraft:max_health modifier add tcc:healing_4 -0.4 add_value
scoreboard players remove @s[scores={tcc.dummy=4..}] tcc.dummy 4
attribute @s[scores={tcc.dummy=2..}] minecraft:max_health modifier add tcc:healing_2 -0.2 add_value
scoreboard players remove @s[scores={tcc.dummy=2..}] tcc.dummy 2
attribute @s[scores={tcc.dummy=1..}] minecraft:max_health modifier add tcc:healing_1 -0.1 add_value
