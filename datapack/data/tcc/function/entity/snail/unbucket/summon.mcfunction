...
execute unless predicate tcc:entity_properties/slots/weapon.mainhand/snail_bucket run data modify storage tcc:temp root.snail_bucket set from entity @s equipment.offhand
