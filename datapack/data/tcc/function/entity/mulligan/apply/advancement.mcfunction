...
function tcc:entity/mulligan/apply/distance_macro with storage tcc:temp root.macro_input

advancement revoke @s only tcc:technical/multiple_trigger_types/all_hail_his_majesty