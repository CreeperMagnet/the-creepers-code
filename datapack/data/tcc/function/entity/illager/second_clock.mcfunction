...
execute if entity @s[tag=tcc.enchanter,tag=!tcc.spellcasting,predicate=tcc:random_chance/0.33] if entity @e[type=#tcc:enchanter_affected,predicate=!tcc:entity_properties/is_affected_by_enchanter,distance=..10] run function tcc:entity/enchanter/spell_start
