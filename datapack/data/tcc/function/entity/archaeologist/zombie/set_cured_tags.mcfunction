...
execute unless data storage tcc:temp root.zombie_data.CustomName run data modify entity @s CustomName set value {"translate":"entity.tcc.archaeologist"}
execute if entity @s[nbt={CustomName:{"translate":"entity.tcc.archaeologist"}}] run team join tcc.no_nametag @s
