...
spreadplayers ~ ~ 0 48 false @s
spreadplayers ~ ~ 0 48 false @s[distance=..10]
spreadplayers ~ ~ 0 48 false @s[distance=..10]
execute at @s positioned over motion_blocking_no_leaves run tp @s ~ ~ ~
execute at @s positioned ~ ~-1 ~ if predicate tcc:location_check/in_water run kill @s 
execute at @s positioned ~ ~-1 ~ if predicate tcc:location_check/in_water run return 0
