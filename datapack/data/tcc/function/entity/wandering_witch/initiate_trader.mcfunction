...
data merge entity @s {DespawnDelay:48000,CustomName:{"translate":"entity.tcc.wandering_witch"},Team:"smithed.prevent_aggression",DeathLootTable:"tcc:entities/wandering_witch",DeathTime:19s,drop_chances:{mainhand:0.0f,offhand:0.0f,head:0.0f,chest:0.0f,legs:0.0f,feet:0.0f},Offers:{Recipes:[]},active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:0b}],Silent:1b,Tags:["tcc.tick","tcc.second_clock","tcc.ten_second_clock","tcc.wandering_witch","tcc.trader_entity","smithed.entity"],equipment:{mainhand:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/body","minecraft:custom_model_data":{"flags":[false,false]}}},head:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/head","minecraft:custom_model_data":{"flags":[false]}}},chest:{id:"minecraft:stone",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/body","minecraft:custom_model_data":{"flags":[false,false]}}}}}
