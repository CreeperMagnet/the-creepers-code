...
data merge entity @s {DespawnDelay:48000,CustomName:'{"translate":"entity.tcc.wandering_witch"}',Team:"smithed.prevent_aggression",DeathLootTable:"tcc:entities/wandering_witch",ArmorDropChances:[-10000.0f,-10000.0f,-10000.0f,-10000.0f],HandDropChances:[-10000.0f,-10000.0f],Offers:{Recipes:[]},active_effects:[{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:0b}],Silent:1b,Tags:["tcc.tick","tcc.second_clock","tcc.ten_second_clock","tcc.wandering_witch","tcc.trader_entity","smithed.entity"],ArmorItems:[{},{},{id:"minecraft:shears",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/body/main"}},{id:"minecraft:shears",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/head/main"}}],HandItems:[{id:"minecraft:shears",count:1,components:{"minecraft:item_model":"tcc:entity/wandering_witch/body/main"}},{}]}
