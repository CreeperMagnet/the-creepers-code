...
execute store result storage tcc:temp root.macro_input.x int 1 run random value -3..3
execute store result storage tcc:temp root.macro_input.z int 1 run random value -3..3
function tcc:entity/geomancer/spawn_explosive/positioned_macro with storage tcc:temp root.macro_input
